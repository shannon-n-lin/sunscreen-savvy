const Hero = () => {
  return (
    <div className='w-full bg-[url("/src/assets/gradient2.png")] bg-cover bg-left-top -mt-[80px]'>
      <div className='h-[550px] p-4 flex flex-col text-center justify-center'>
        <h1 className='mt-12 mb-4 text-4xl md:text-5xl/tight max-w-[476px] md:max-w-[680px] mx-auto font-semibold'>Find a sunscreen that works for your skin</h1>
